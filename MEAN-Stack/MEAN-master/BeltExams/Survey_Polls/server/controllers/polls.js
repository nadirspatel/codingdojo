...
module.exports = {
    ...
    create: function (req, res) {
        var newPoll = new Poll({question: req.body.question, created_by: req.body.created_by});
        newPoll.save((err) => {
            if(err){
        ...
        return res.json("New Poll created successfully")
    },
    ...
    delete: function (req, res) {
        ...
        return res.json("Deleted Poll Successfully!")
    },
